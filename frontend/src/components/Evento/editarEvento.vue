                        ...
                        <form @submit = "onSubmit">
                            ...
                            <!--    -->
                             ...
                             <div class="form-group row">
                                <label for="title" class="col-sm-2 col-form-label"></label>
                                <div class="col-sm-6"> 
                                <b-form-timepicker v-model="horaEvento" locale="en" class ="form-control" v-model.trim = "form.horaEvento"></b-form-timepicker>
                            ...
                            <div class="form-group row">
                                <label for="title" class="col-sm-2 col-form-label"></label>
                                    <div class="col-sm-6">
                                        <input type="text" placeholder="Fecha del Evento" name="fecha" class ="form-control" v-model.trim = "form.fechaEvento">
                                    </div>
                            </div>
    ...
    methods:{
        ...
        onSubmit(evt){
            ...
            axios.put(path, this.form).then((response) =>{
                ...
                swal("Evento actualizado exitosamente!!", "", "success")                
            })
            .catch((error) => {
                console.log(error)
                swal("El Evento no ha sido Actualizado", "", "error")
            })
        },
